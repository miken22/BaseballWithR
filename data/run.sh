...
for filename in *.EVA; do
    ./BEVENT.EXE -y 2015 -f 0-9,12-13,16-17,26-40,43-45,51,58-61 "$filename" >> al_data.txt
done
...
for filename in *.EVN; do
    ./BEVENT.EXE -y 2015 -f 0-9,12-13,16-17,26-40,43-45,51,58-61 "$filename" >> nl_data.txt
done
